...
This document will detail the test cases used in order to validate the project. It will be used by testers of the project in order to increase confidence in the code. The document will be created by all members of Grate; however, the responsibility of maintaining the document will rest with the Quantitative Testing Expert.

\item{Design Specification Document}

This document will document the internal workings of the code. It will be used by future developers who want to learn how the current system functions. The document will be created by all members of Grate, and the responsibility of maintaining this document will lie with all members of Grate.

\item{User Manual}

The user manual will detail the operation procedures for Grate's Genetic Cars. It will explain to the users of Grate's Genetic Cars all of the different functions that Genetic Cars supports, as well as the role that different parameters play in the Genetic Algorithm. This document will be created by all members of Grate; however, the responsibility of maintaining the document will rest with the theory expert.
\end{enumerate}

\subsubsection{Training Requirements}
No specific training beyond what is listed under assumptions will be required of the user.
...
\textbf{Originator:} Kelvin Lin\\
\textbf{Fit Criterion:} The user can elect to see graphical output of a previous generation's cars.\\
%  
\textbf{Supporting Materials:} JavaScript \\
