...
The most significant risk implementing the basic car model is...

\subsection{The Genetic Algorithm}
The purpose for implementing the GA will be to demonstrate its practicality to the project. In order for this portion to succeed, it must be able to select for the top n cars given an array of cars, n, and fitness scores as input; crossover genes genes of these cars; and mutate the genes of the offsprings.
...
\subsubsection{The Risks}
The most significant risk for implementing the GA is...
...
\subsubsection{The Risks}
The most significant risk for implementing the graphics is...
...
%%occurs, Team 8 is well prepared to transition to the Java programming language, 
%%as it is one with which we are more familiar. Java was chosen as a back-up 
%%language as it is the programming language that team 8 is the most familiar with 
%%and is very easy to convert to from Java Script so that we do not lose progress 
%%already made. The need for a switch from the Java Script programming language is 
