...
by the use of Java’s built in unit test functionality. Dox will serve as our primary document generator, and QUnit will serve as our means of automated testing.
...
expert believes that JavScript will work best for his role. Our final project will also closely 
...
\subsection{Dox}
Dox will serve as our means of document generation in Javascript. Dox is a JavaScript documentation generator written with node that was discovered on gitlab. It gives a JSON representation from JavaScript and its well documented nature makes it a good choice for this project. The original source of Dox can be found at

\href{https://github.com/tj/dox}.

\subsection{QUnit}
QUnit was chosen for the automated testing for this project. Its similarity to JUnit, an automated testing software Team 8 is familiar with from past projects, means that it will be easy to adapt to, and its cross platform flexibility means that it is unlikely to cause technical problems. The original source of QUnit can be found at
...
this project.  The exact guidelines for this coding style can be found at

\href{https://developer.mozilla.org/en-US/docs/Mozilla/Developer_guide/Coding_Style}.
