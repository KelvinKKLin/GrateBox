...
\subsubsection{The Risks}
\textcolor{red}{Include a specific online resource to use so all team members 
have a common baseline understanding - CM} \\
...
\textcolor{red}{Use a link relative to the \LaTeX document and not over the 
HTTPS protocol - CM} \\
...
The past four months have been successful for Grate. Grate accomplished all of 
...
The members of Grate were able to experience first-hand the thrills and 
...
From the beginning, a key lesson Grate learned was to start coding early, but 
...
Moreover, creating the different documents for the project allowed the members 
...
Macroscopically, the iterative process that Grate used was very effective in 
...
Nevertheless, GrateBox is still in its early stages of development, and there 
...
With respect to software project management, the use of PERT charts, agile 
...
Ultimately, the members of Grate started this project with no prior experience 
