...
See Gantt Chart at
\href{https://gitlab.cas.mcmaster.ca/linkk4/GrateBox/tree/master/ProjectSchedule}{the GitLab Repository}.
...
Input: Pre determined random seed and faulty car generation module run for vector magnitudes.
...
How test will be performed:  Given car will be run through chromosome script. Output text file will be manually examined by testing team to determine validity. Chromesome will be successfully created if resulting text file contains the five corresponding arrays for a car and a mass value.
\end{enumerate}
