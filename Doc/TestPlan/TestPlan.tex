...
\textcolor{RoyalPurple}{Input: Pre determined random seed and faulty car generation 
module run for 
vertex number.}
					
Output: Error message displayed
					
\textcolor{RoyalPurple}{How test will be performed: Car will be randomly created. Error 
message should 
occur if test successful.}
...
9. Are there any suggestion or recommendations you would like to make towards the 
