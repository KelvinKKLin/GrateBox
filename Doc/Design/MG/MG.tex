...
\begin{description}
\item[\refstepcounter{ucnum} \uctheucnum \label{ucVehicleChange}:] 
\item[\refstepcounter{ucnum} \uctheucnum \label{ucFitnessRequirements}:] 
\item[\refstepcounter{ucnum} \uctheucnum \label{ucCarSpeed}:] 
\item[\refstepcounter{ucnum} \uctheucnum \label{ucLibrary}:] 
\end{description}
